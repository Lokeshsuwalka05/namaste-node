...
##👉 Node.js does not wait for tasks like file reading, API calls, or database queries to finish.
...
4.When the task finishes (event occurs)

5.The event loop runs the callback
